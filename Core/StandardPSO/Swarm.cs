...
namespace SPSO_2007
{
    public class Swarm
    {
        ...
        public Swarm(int maxSwarmSize)
        {
             ...
             * */
            P = Enumerable.Repeat(new Position(maxSwarmSize), maxSwarmSize).ToArray();
            X = Enumerable.Repeat(new Position(maxSwarmSize), maxSwarmSize).ToArray();
            V = Enumerable.Repeat(new Velocity(maxSwarmSize), maxSwarmSize).ToArray();
        }
