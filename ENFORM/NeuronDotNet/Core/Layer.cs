...
namespace NeuronDotNet.Core
{
    ...
    public abstract class Layer<TNeuron> : ILayer where TNeuron : INeuron
    {
        ...
        /// <summary>
        /// ENFORM EDIT: 
        /// Stores the amount of groups of neurons that share a whole set of inputs
        /// Set to -1 to make everything normal.
        /// </summary>
        protected int inputGroups = -1;
        ...
        /// <summary>
        /// ENFORM EDIT: 
        /// Gets or sets the amount of groups of neurons that share a whole set of inputs
        /// Set to -1 to make everything normal.
        /// </summary>
        public int InputGroups
        {
            get { return inputGroups; }
            set { inputGroups = value; }
        }
