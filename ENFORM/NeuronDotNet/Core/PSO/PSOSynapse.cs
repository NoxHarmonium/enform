...
namespace NeuronDotNet.Core.PSO
{
    ...
    public class PSOSynapse : ISynapse
    {
        ...
        /// </exception>
        public PSOSynapse(
            ActivationNeuron sourceNeuron, ActivationNeuron targetNeuron, PSOConnector parent)
        {
